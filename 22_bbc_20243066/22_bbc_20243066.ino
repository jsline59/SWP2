...
#define _DUTY_MIN 816 // 1000

#define _SERVO_ANGLE_DIFF  236  // Replace with |D - E| degree
...
float volt_to_distance(int a_value)
{
  ...
  return 1229 + (-6.74) * a_value + 0.013 * a_value * a_value + (-8.59e-06) * a_value * a_value * a_value;
}
